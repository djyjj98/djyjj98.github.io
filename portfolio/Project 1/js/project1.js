document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    document.querySelector("#add-classes").addEventListener('click', () => {
        ...
        document.querySelector('.selector-examples li:nth-child(4)')
    	.classList.add('highlighter');

		document.querySelector('.selector-examples li:nth-child(5)')
    	.classList.add('highlighter');

		document.querySelector('.selector-examples li:last-child')
    	.classList.add('last');
    });
    ...
    */
    ...
    document.querySelector("#change-language").addEventListener('click', () => {
		...
		element.forEach(language => {
			language.innerHTML = inputValue;
    });
  });
    /* PART 4: TOGGLES
    --------------------------------------------------
